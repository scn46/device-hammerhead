...
LOCAL_KERNEL := device/lge/hammerhead_svelte-kernel/zImage
else

ifneq ($(filter hammerhead_fp aosp_hammerhead_fp,$(TARGET_PRODUCT)),)
LOCAL_KERNEL := device/lge/hammerhead_fp-kernel/zImage
else
LOCAL_KERNEL := device/lge/hammerhead-kernel/zImage
endif
